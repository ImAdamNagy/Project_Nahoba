            ...
            <div id="formdiv">
                <VForm @submit="registerUser" class="form-group" :validation-schema="schema">
                    ...
                    <div class="d-flex flex-column flex-xl-row justify-content-between">
                        <Router-link class="btn w-50 btn-secondary my-md-3 my-2 rounded-pill" to="/">Back</Router-link>
                        <Router-link class="btn w-50 btn-secondary my-md-3 my-2 rounded-pill" to="/login">Go to Login</Router-link>
